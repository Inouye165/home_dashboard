...
interface RealTempPanelProps {
  data: ESP8266Data | null;
  loading: boolean;
}

const RealTempPanel: React.FC<RealTempPanelProps> = ({ data, loading }) => {
  const moduleData = data?.module115;
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg">
            <div className="flex items-center">
              <Thermometer className="w-6 h-6 text-green-500 mr-3" />
              <div>
